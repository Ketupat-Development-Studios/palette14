...
$mobile = false;
	...
	<head>
		...
		<style>
			body{max-width: 100%;margin:0;padding:0 0 20px 0;background-color:#006600;overflow-x:hidden;font-family: 'Open Sans', sans-serif;} .top{height:40vw;} 
			.top *{position:absolute;z-index:5;}
			#main{width:100%;position:absolute;margin-top:-200px;}
			.vjs-control-bar{position:relative;}
			div.video-js{margin:auto;z-index:5;overflow:hidden;}
			.vjs-fullscreen-control{display: none;}
			.vjs-default-skin .vjs-volume-control{margin-right: 20px;}
			#banner{width:70%;transform: translateX(15%);}
			#logo{right:0;width:5%;margin:15px 15px 0 0;}
			.clear{clear:both;}
			.bottom{position:absolute;width:800px;margin:300px auto 20px auto;z-index:6;}
			.share{display:inline-block;font-size:1.8em;color:#fff;margin:0 0 0 20px;cursor:pointer;text-align:center;}
			h2{color:#fff;font-weight:300;margin:0 0 20px 0;}
			p.nospaceforpotatoes{margin:10px 0 0 0;color:#fff;}
			#palette_video_html5_api{overflow:hidden;}
			#disclaimer{text-align:center;color: white;width: 100%;}
		</style>
		<script>   
			(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){   (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),   m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)   })(window,document,'script','//www.google-analytics.com/analytics.js','ga');    ga('create', 'UA-57000907-2', 'auto');   ga('send', 'pageview');  
		</script>
	</head>
